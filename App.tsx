        ...
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 text-sm font-medium text-gray-700">
             ...
             <div className="relative z-50">
               ...
               >
                 <img src={MOCK_USER_PROFILE.avatar} className="w-8 h-8 rounded-full border border-gray-200" alt="Avatar"/>
                 <span className="font-semibold text-gray-700">{MOCK_USER_PROFILE.firstName}</span>
               </button>
               ...
               {isUserMenuOpen && (
                 <div className="absolute top-full right-0 mt-2 w-56 bg-white border border-gray-100 rounded-2xl shadow-xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                    <div className="p-4 border-b border-gray-50 bg-gray-50/50">
                       <p className="text-sm font-bold text-gray-900">{MOCK_USER_PROFILE.firstName} {MOCK_USER_PROFILE.lastName}</p>
                       <p className="text-xs text-gray-500">{MOCK_USER_PROFILE.email}</p>
                    </div>
                    <div className="p-1">
                       <button 
